...
# Resize image proportional to original dimension
def arrange_width(img, new_height):
    width, height = img.size
...
def create_ad_template(main_img, logo_img, color, punchline_text, button_text, ):
    ...
    draw.rectangle([button_position, (button_position[0] + button_width, button_position[1] + button_height)], fill=color)
